            ...
            <div class="section row">
                <div class="col-md-12">
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <a class="cupom-click" href="{{route('promotions.redeem',$promotion->id)}}">
                                    <div class="cupom">
                                        ...
                                        <div class="black-canvas">
                                            <img class="cupom-img-top" alt="Parceiro" src="{{$promotion->image ?? asset('img/colepom_logo.png')}}" width="450"
                                                 height="600">
                                        </div>
                                        ...
                                        <div class="cupom-block">
                                            ...
                                            <div class="cupom-place">
                                                ...
                                                <div class="cupom-place-text">
                                                        <span class="cupom-parceiro" data-toggle="tooltip"
                                                              title="Pizzaria Andreon">{{$promotion->store->name}}</span>
                                                    <br>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        @empty
                            <p>Nenhuma promocão cadastrada para esse parceiro</p>
                        @endforelse
                    </div>
                </div>
            </div>
