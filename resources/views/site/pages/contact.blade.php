                    ...
                    <div class="header-perfil">
                        <div class="row justify-content-center">
                            <div class="col-md-3 col-sm-4">
                                <div class="black-canvas">
                                    <img class="cupom-img-top" alt="Parceiro" src="/img/colepom_bg_white.png"
                ...
                <div class="col-md-6 offset-md-3">
                    <form class="form-horizontal">
                        <div class="form-group row">
                            <div class="col-md-12">
                                <input name="nome" placeholder="Nome" class="form-control" required="required"
                                       type="text">
                            </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                <input name="email" placeholder="Email" class="form-control" required="required"
                                       type="email">
                            </div>
                            <div class="col-md-6">
                                <input name="telefone" placeholder="Telefone" required="required" class="form-control"
                                       type="text">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                <textarea name="msg" cols="40" rows="5" class="form-control"
                                          placeholder="Deixe sua mensagem (opcional)"></textarea>
                            </div>
                        </div>
