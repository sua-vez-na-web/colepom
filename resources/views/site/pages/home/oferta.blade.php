...
@section('content')
	...
	<div class="container">
		...
		<!-- <div class="row justify-content-center">
			<div class="col-md-8 contacts">
				...
				<div>
					<a href="#">
						<i class="fab fa-facebook"></i> /pizzariaandreon
					</a>
				</div>
				<div>
					<a href="#">
						<i class="fab fa-instagram"></i> @pizzariaandreon
					</a>
				</div>
				<div>
					<a href="#">
						<i class="fab fa-twitter"></i> @pizzariaandreon
					</a>
				</div>
				<div>
					<i class="fas fa-phone"></i> +55 27 3333-3333
				</div>
				<div>
					<i class="fas fa-phone"></i> +55 27 9 9999-9999
				</div>
				<div>
					<a href="#">
						<i class="far fa-envelope"></i> contato@pizzaria.com.br
					</a>
				</div>
				<div>
					<a href="#">
						www.pizzariaandreon.com.br
					</a>
				</div>
	...
	<div class="container-fluid">
		<div class="row justify-content-center">
			<div class="oferta">
				<div class="oferta-title">Mensal</div>
				<div class="oferta-price">29,90</div>
				<div class="oferta-period">Por mês</div>
			</div>
			<div class="oferta">
				<div class="oferta-title">Trimestral</div>
				<div class="oferta-price">24,90</div>
				<div class="oferta-period">Por mês</div>
			</div>
			<div class="oferta">
				<div class="oferta-title">Anual</div>
				<div class="oferta-price">20,90</div>
				<div class="oferta-period">Por mês</div>
			</div>
