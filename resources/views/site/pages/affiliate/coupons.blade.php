                ...
                <table class="table table-hover" id="dataTables-example">
                    ...
                    @foreach($coupons as $coupon)
                        <tr>
                            ...
                            <td>{{ $coupon->coupon->promotion ?  $coupon->coupon->promotion->redeem_expiration_date->format('d/m/Y')  : ''}}</td>
                            <td>{{ $coupon->redeem_at ? $coupon->redeem_at->format('d/m/Y') : ''}}</td>
                            <td>{{ $coupon->used_at ? $coupon->used_at->format('d/m/Y') : '--'}}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
