...
@section('content')
	...
	<div class="container mt-5">
		<div class="row">
			@if($promocao)
			<div class="col-md-4 orange-cupom-box">
				<div class="cupom orange-cupom">
					...
					<div class="cupom-block">
						...
						<div class="cupom-descricao">
							<p> {{ $promocao->PRO_DESCRICAO }} </p>
							<br>
						</div>
						<div class="cupom-place">
							<div class="map-marker white">
							</div>
							<div class="cupom-place-text">
								...
								<br>
								<span class="cupom-local" data-toggle="tooltip" title="Vila Velha, Praia da Costa">{{ $parceiro->EST_CIDADE }}, {{ $parceiro->EST_BAIRRO }}</span>
							</div>
						</div>
						<div class="cupom-btn-box">
							<button class="btn btn-block btn-light-colored">
								Adquirir Cupom
							</button>
						</div>
					</div>
