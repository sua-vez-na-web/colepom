...
<div class="row">
    ...
    <div class="form-group col-md-3 col-sm-12  @error('mobile_phone') has-error @enderror">
        <label>Celular</label>
        <input class="form-control cnpj" name="mobile_phone" type="text" value="{{ $syndicate->mobile_phone ?? @old('mobile_phone') }}">
        @error('mobile_phone')
        <span class="text-danger">{{ $message ?? '' }}</span>
        @enderror
    </div>
    <div class="form-group col-md-3 col-sm-12  @error('municipal_inscription') has-error @enderror">
        ...
        <input class="form-control cnpj" name="municipal_inscription" type="text" value="{{ $syndicate->municipal_inscription ?? @old('municipal_inscription') }}">
    ...
    <div class="form-group col-md-3 col-sm-12  @error('state_inscription') has-error @enderror">
        ...
        <input class="form-control cnpj" name="state_inscription" type="text" value="{{ $syndicate->state_inscription ?? @old('state_inscription') }}">
