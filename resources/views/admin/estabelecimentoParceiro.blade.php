                            ...
                            <div class="row">
                               ...
                               {!! Form::open(['route'=>'admin_par_est_submit', 'method'=>'post']) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="parceiro_id">
                                            @foreach($parceiros as $parceiro)
                                                <option class="form-control" name="parceiro_id" value="{{$parceiro->PAR_ID}}" {{ $parceiro->PAR_ID == $estabelecimento->PAR_ID ? 'selected': null}}>{{$parceiro->PAR_FANTASIA}}</option>
                                            @endforeach
                                        </select> 
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success">
                                                                    ...
                                                                    <a href="{{route('admin_par_est_list')}}" type="reset" class="btn btn-danger">Voltar</a>
                                    </div>
