        ...
        <div class="section row">
            <div class="col-md-12">
							...
							<div class="cupom">
								...
								<div class="cupom-block">
									...
									<div class="cupom-place">
										...
										<div class="cupom-place-text">
											<span class="cupom-parceiro" data-toggle="tooltip" title="{{ $promocao->PAR_FANTASIA }}"> {{ $promocao->PAR_FANTASIA }} </span>
											<br>
											<span class="cupom-local" data-toggle="tooltip" title="{{ $promocao->EST_CIDADE }}, {{ $promocao->EST_BAIRRO }}">{{ $promocao->EST_CIDADE }}, {{ $promocao->EST_BAIRRO }}</span>
										</div>
									</div>
								</div>
							</div>
                ...
                <div class="text-center">
                    <a href="{{ route('promocoes') }}" class="btn colored">Ver mais</a>
                </div>
            </div>
        </div>
    </div>
